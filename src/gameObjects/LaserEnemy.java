...
/**
 * Implementa los disparos de los enemigos
...
public class LaserEnemy extends MovingObject{
     ...
     */
    public LaserEnemy(Vector2D position, Vector2D velocity, double maxVelocity, double angle, BufferedImage texture, GameState gameState) {
